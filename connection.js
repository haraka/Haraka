...
class Connection {
    ...
    _process_data () {
        ...
        // msimerson suggested not using the conditional expression here for readability
        let maxlength = this.max_line_length;
    ...
    cmd_proxy (line) {
        ...
        // FIXME: the switch-case here was triggering SonarLint; tried to fix it up.
