...
exports.is_acl_allowed = function (connection) {
    if (!this.acl_allow || !this.acl_allow.length) { return false; }
    ...
    for (const item of this.acl_allow) {
        ...
        if (!net.isIP(c_net) || net.isIPv4(ip) && net.isIPv6(c_net) || net.isIPv6(ip) && net.isIPv4(c_net)) continue;  // bad config entry
...
exports.force_routing = function (next, hmail, domain) {
    if (!this.cfg.relay.force_routing || !this.dest || !this.dest.domains) { return next(); }
